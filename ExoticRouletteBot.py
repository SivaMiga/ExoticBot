...
Exotics = ["Cerberus +1", "Monte Carlo", "SUROS Regime", "Sweet Business", "Wish Ender", "Ace of Spades", "Crimson", "Lumina", "Malfeasance", "Sturm", "Last Word", "Thorn", "Bad JuJu", "No Time to Explain", "Outbreak Perfected", "Vigilance Wing", "MIDA Multi-Tool", "The Jade Rabbit", "Rat King", "Traveler's Chosen", "Friends Choose", "The Huckleberry", "Hard Light", "Tommy's Matchbook", "Le Monarque", "Trinity Ghoul", "Fighting Lion","You Choose", "Sunshot", "Graviton Lance", "Polaris Lance", "Skyburner's Oath", "Symmetry", "Devil's Ruin", "Riskrunner", "Tarrabah", "Khvostov 7G-02"]
Kinetic = ["Cerberus +1", "Monte Carlo", "SUROS Regime", "Sweet Business", "MIDA Multi-Tool", "Jade Rabbit", "Bad Juju", "No Time to Explain", "Outbreak Perfected", "Vigilance Wing", "Ace of Spades", "Crimson", "Lumina", "Malfeasance", "Sturm", "The Last Word", "Thorn", "Rat King", "Traveler's Chosen", "Bastion", "Arbalest", "Witherhoard", "The Chaperone", "Izanagi's Burden"]
